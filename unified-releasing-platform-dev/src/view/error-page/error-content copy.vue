        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
          ...
          <g id="train">
            ...
            <g id="car-layers">
              ...
              <g id="Text">
                <text transform="translate(377.037 230.025)" class="st8 st10" font-size="21">{{code}}</text>
                <text
                  transform="translate(490 213.994)"
                  class="st8 st10"
                  font-size="24.025"
                >{{code == 404 ? "Page not found." :code == 401 ? 'Oh~~您没有浏览这个页面的权限~':'Oh~~鬼知道服务器经历了什么~' }}</text>
              </g>
              <g id="ladders">
                <g id="ladder-f">
